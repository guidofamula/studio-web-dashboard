        ...
        <div class="container">
            <div class="w-full px-4">
                <div class="mx-auto mb-16 max-w-xl text-center">
                    <h2 class="mb-4 text-3xl font-bold uppercase text-dark dark:text-primary sm:text-4xl lg:text-3xl">Tag
                        Postingan</h2>
                    <div class="mt-10">
                        <a href="#"
            ...
            <div class="flex flex-wrap">
                ...
                @empty
                    <div class="w-full px-4 pt-36 pb-32 text-center">
                        <h3 class="mb-4 text-3xl font-bold text-dark dark:text-secondary sm:text-4xl lg:text-5xl">
                            Artikel belum ada untuk tag
