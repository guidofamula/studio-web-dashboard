...
@section('content')
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="form-group">
            ...
            <input name="email" class="form-control @error('email') is-invalid @enderror py-4" id="input_login_email"
        ...
        <div class="form-group">
            ...
            <input name="password" class="form-control @error('password') is-invalid @enderror py-4"
